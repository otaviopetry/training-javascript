...
function convertHourFormat (hour12) {
    ...
    if (isPm) {        
        // if hour is 12, return 00, else, add 12
        hour === '12' 
            ? convertedHour = '12'
            : convertedHour = (Number(hour) + 12).toString();
...
console.log(convertHourFormat(hour12));